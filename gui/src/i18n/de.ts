...
export const de = {
  ...
  "theme.system": "System",
  "lang.label": "Sprache",
  "dash.subtitle": "Live-Status des lokalen Grok Build App-Proxys, seiner Anbieter und der in Codex gerouteten Modelle.",
  "dash.status": "Status",
  "dash.online": "Online",
  ...
  "dash.codexAutoStart": "Grok Build App mit Codex starten",
  ...
  "dash.maintenanceHint": "Aktualisiere Codex’ Modellkatalog oder installiere eine neuere Grok Build App-Version.",
  ...
  "dash.projectConfigTitle": "Projekt-Codex-Konfig umgeht Grok Build App",
  "dash.projectConfigHint": "Diese repo-lokalen Einstellungen überschreiben den Grok Build App-Proxy (z. B. direkt zu OpenCode Go routen). Entferne sie, damit die Routing aus ~/.codex/config.toml in diesem Projekt greift.",
  "dash.checkUpdate": "Update prüfen",
  "dash.updateTitle": "Grok Build App aktualisieren",
  ...
  "dash.updateStatus.running": "Grok Build App wird aktualisiert.",
  ...
  "prov.subtitle": "Konfiguriere die Upstream-Anbieter, die Grok Build App in Codex routet. Melde dich mit einem Konto an, füge einen Anbieter hinzu oder bearbeite die Rohkonfiguration.",
  ...
  "models.subtitle": "Steuere, welche Modelle Codex sieht — natives GPT-Passthrough und geroutete Anbieter, nach Anbieter gruppiert (Kopfzeile zum Einklappen anklicken). Deaktivierte Modelle sind im Katalog und in der Modellauswahl verborgen. Änderungen gelten bei der nächsten Codex-Runde — Grok Build App invalidiert Codex 5-Minuten-Modell-Cache, kein Neustart nötig.",
  ...
  "sub.subtitle": "Codex {cmd} bewirbt nur die ersten 5 Modelle (nach Priorität) als Overrides. Wähle hier bis zu 5 — natives gpt oder geroutet — und Grok Build App setzt ihre Katalog-Priorität, sodass genau diese führen. Jedes andere Modell bleibt über seinen exakten Namen aufrufbar; dies steuert nur die Anzeige.",
  ...
  "logs.subtitle": "Letzte Anfragen über den lokalen Grok Build App-Proxy, neueste zuerst.",
  ...
  "api.subtitle": "Nutze generierte API-Schlüssel, um von externen Apps auf den Grok Build App-Proxy zuzugreifen. Schlüssel authentifizieren über den {authHeader}- oder {altHeader}-Header.",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "cws.howBody": "In Codex combo/<id> anfragen. Grok Build App wählt ein Ziel und springt nur bei wiederholbaren Upstream-Fehlern. Ist kein Ziel verfügbar, schlägt die Anfrage geschlossen fehl, statt den globalen Standardanbieter zu verwenden.",
